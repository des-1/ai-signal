...
const DEFAULT_TOP10_PROMPT = "Find the 10 most important AI stories from the past 24 hours that are directly relevant to business professionals and decision-makers. Coverage must include guaranteed slots for: Finance & Banking, Law & Legal, Healthcare & Pharmaceutical, Media & Marketing, Defense & Security, and Technology & AI (major announcements from Anthropic, OpenAI, Google DeepMind, Meta AI, Microsoft, Amazon/AWS, Apple, IBM, Salesforce, or NVIDIA — new models, product launches, pricing changes, or policy moves with clear business impact). Remaining slots should cover other industries including energy, construction, logistics, education, engineering, manufacturing and retail. Focus on AI adoption by businesses and organisations, regulatory changes affecting industries, AI tools changing professional workflows, and major funding or partnerships. Avoid academic research, developer tools, and generic AI model benchmarks unless they have clear business implications.";
